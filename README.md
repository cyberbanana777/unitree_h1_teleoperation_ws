...
* **`completed_scripts_teleoperation`**: Содержит пайтон launch-файлы, которые запускают конфигурации нод из данного репазитория для задач соответсвующих названиям launch-файлов.
...
Для выбора суставов, положения которых отслеживаются, в launch-файле нужно изменить список `JOINTS_TO_CHECK`. 
```bash
...
| :--------- | :----------------- | :-------------------- | :------------------------------------------------------------------------------------------------- |
| Публикация | `/Fedor_data_rad`  | `std_msgs/msg/String` | Угловые положения суставов УКТ в радианах и степень разжатия пальцев в условных единицах от 0 до 1 |
| Подписка   | `/Fedor_bare_data` | `std_msgs/msg/String` | Исходные угловые положения суставов с УКТ в JSON-формате                                           |
...
| Публикация   | `/plotjuggler/joint_{H1_joint_num}/fedor`<br> | `std_msgs/msg/Float32`<br>   | Угловое положение выбранного сустава Unitree H1  в радианах или степень разжатия пальца в условных единицах от 0 до 1<br> |
| Подписка     | `/Fedor_data_rad`                             | `std_msgs/msg/String         | Угловые положения суставов  УКТ в радианах и степень разжатия пальца в условных единицах от 0 до 1                        |
...
| Тип услуги | Топик              | Тип сообщения         | Описание                                                 |
| :--------- | :----------------- | :-------------------- | :------------------------------------------------------- |
| Публикация | `/Fedor_bare_data` | `std_msgs/msg/String` | Исходные угловые положения суставов с УКТ в JSON-формате |
