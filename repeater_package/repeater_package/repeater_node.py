...
"""
АННОТАЦИЯ
ROS2-нода для приема UDP-пакетов с JSON-данными и их ретрансляции в ROS2-
топик. Прослушивает указанный IP-адрес и порт (192.168.123.162:34567),
публикует данные в топик "ukt_bare_data" с частотой 333.3 Гц. Обеспечивает
обработку ошибок и корректное завершение работы с освобождением ресурсов.
