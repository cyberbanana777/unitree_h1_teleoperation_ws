...
# Joint mapping between UKT and Unitree H1
JOINT_MAPPING_UKT_TO_UNITREE_H1 = {
    # Left Arm
...
class UKTJointConverter(Node):
    ...
    def convert_to_unitree_h1(self, data: list) -> dict:
        ...
        for i, joint_data in enumerate(data):
            ...
            unitree_index = JOINT_MAPPING_UKT_TO_UNITREE_H1[i]
    ...
    def timer_callback(self):
        ...
        try:
            ...
            converted_data = self.convert_to_unitree_h1(joint_data)
            output_msg = String()
